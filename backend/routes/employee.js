...
import { getEmployees, createEmployee, updateEmployee, deleteEmployee, importEmployees,downloadSampleExcel } from '../controllers/employeeController.js';
...
router.get('/', auth, roleMiddleware(['Admin', 'SuperAdmin']), getEmployees);
